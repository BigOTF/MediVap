    ...
    <div className='w-full  px-[30px] mt-[40px] md:px-[100px] md:mt-[80px] flex flex-col items-center justify-center gap-[30px] md:gap-[50px]'>
        ...
        <div className='flex flex-col items-center gap-[30px] md:flex-row md:gap-[20px]'>
            ...
            <div className='grid md:grid-cols-2 gap-[20px] md:gap-[25px] w-[70%] md:w-[100%] space-y-8'>
                ...
                <div data-aos="fade-up" data-aos-delay="800"  className='flex flex-col gap-[8px] rounded-[8px] py-[32px] px-[16px] md:py-[48px] bg-[#F6F6F6] opacity-0 transition-opacity duration-300'>
                    <div className='flex flex-col gap-[16px]'>
