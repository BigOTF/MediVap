...
const JoinUs = () => {
  return (
    <div className='w-full bg-[#002C5B] flex flex-col md:flex-row items-center gap-[50px] py-[40px] px-[30px] mt-[70px] md:py-0 md:gap-0 md:px-[204px] md:mt-[200px] md:h-[498px]'>
        ...
        <div>
            <img src={'/joinUs.png'} className='md:w-[658.95px] md:h-[685.26px]'/>
        </div>
    </div>
  )
}
